            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="employeeprofile.jsp"><i class="fa fa-dashboard fa-fw"></i> ADD Employee</a>
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="morris.html">Delete Data</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
...
<form action="/egsemployeeapp/EgsloginServlet" method="post">
                                        ...
                                        <style="width: 10px; height: 10px; align="left" >
                                            <span id="contentholder1_lblEmpID" class="labelStyle" "> Emp Name :</span>
                                           

                    <span>  <input type="text" name="Ename" >   <button class="btn btn-default" type="submit">
...
<tr style="text-align:"center">
                                        <td style="width: 10px; height: 10px; text-align: "center";>
                                            <span id="contentholder1_lblDesg" class="labelStyle" ">FatherName: </span>
                                          <span> <input type ="text" name="Fname"disabled/></span></td>
                                    </tr>
 ...
 <tr style="text-align: left">
                                        <td style="width: 10px; height: 10px; text-align: left;">
                                            ...
                                            <span> <input type ="text" name="Mname"disabled/></span></td>
                                    </tr>
                ...
                <tr style="text-align: left">
                   ...
                   <span id="contentholder1_lblDesg" class="labelStyle" style="font- weight:bold;">Address: </span>
                                            <span> <input type ="text" name="Addr"disabled/></span></td>
                                    </tr>
                ...
                <tr style="text-align: left">
                   ...
                   <span id="contentholder1_lblDesg" class="labelStyle" style="font- weight:bold;">City : </span>
                                            <span> <input type ="text" name="City"disabled/></span></td>
                                    </tr>
                ...
                <tr style="text-align: left">
                   ...
                   <span id="contentholder1_lblDesg" class="labelStyle" style="font- weight:bold;">District : </span>
                                            <span> <input type ="text" name="Dist"disabled/></span></td>
                                    </tr>
                ...
                <tr style="text-align: left">
                   ...
                   <span id="contentholder1_lblDesg" class="labelStyle" style="font- weight:bold;">State: </span>
                                           <span> <input type ="text" name="State"disabled/></span></td>
                                    </tr>
...
<tr style="text-align: left">
                   ...
                   <span id="contentholder1_lblDesg" class="labelStyle" style="font- weight:bold;">Qualification: </span>
                                            <span> <input type ="text" name="Quali"disabled/></span></td>
                                    </tr>
...
<tr style="text-align: left">
                   ...
                   <span id="contentholder1_lblDesg" class="labelStyle" style="font- weight:bold;">PhoneNumber: </span>
                                            <span> <input type ="text" name="Phone"disabled/></span></td>
                                    </tr>
...
<tr style="text-align: left">
                       <td style="width: 0px; height: 10px; text-align:center;">
                                            ...
                                            <span> <input type ="button" name="Save" value=" Update "/></span></td>
                                    </tr>
...
<tr style="text-align: left">
                                        <td style="width: 10px; height: 10px; text-align: left;">
                                           ...
                                           <span> <input type ="text" name="Date"disabled/></span>
                                        </td>
                                    </tr>
                                    <tr style="text-align: left">
                                        <td style="width: 10px; height: 10px; text-align: left;">
                                            <span id="contentholder1_lblDesg" class="labelStyle">Exprience: </span>
                                            <span> <input type ="text" name="Exp"disabled/></span></td>
                                    </tr>
                ...
                <tr style="text-align: left">
                   ...
                   <span id="contentholder1_lblDesg" class="labelStyle" style="font- weight:bold;">Joined As: </span>
                                            <span> <input type ="text" name="Joine"disabled/></span></td>
                                    </tr>
                ...
                <tr style="text-align: left">
                   ...
                   <span id="contentholder1_lblDesg" class="labelStyle" style="font- weight:bold;">Salary: </span>
                                           <span> <input type ="text" name="Salary"disabled/></span></td>
                                    </tr>
                ...
                <tr style="text-align: left">
                   ...
                   <span id="contentholder1_lblDesg" class="labelStyle" style="font- weight:bold;">Position : </span>
                                            <span> <input type ="text" name="Position"disabled/></span></td>
                                    </tr>
                ...
                <tr style="text-align: left">
                   ...
                   <span id="contentholder1_lblDesg" class="labelStyle" style="font- weight:bold;"> Location</span>
                                            <span> <input type ="text" name="Location"disabled/></span></td>
                                    </tr>
...
<tr style="text-align: left">
                   ...
                   <span id="contentholder1_lblDesg" class="labelStyle" style="font- weight:bold;">Increment</span>
                                            <span> <input type ="text" name="Increment"disabled/></span></td>
                                    </tr>
...
<tr style="text-align: left">
                   ...
                   <span id="contentholder1_lblDesg" class="labelStyle" style="font- weight:bold;">Acc NUmber</span>
                                            <span> <input type ="text" name="Acc"disabled/></span></td>
                                    </tr>
...
<tr style="text-align: left">
                       <td style="width: 0px; height: 10px; text-align: center;">
                          <span> <input type ="button" name="Clear" value="Clear Details"disabled/></span></td>
                                    </tr>
