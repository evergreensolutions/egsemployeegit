                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="managerdelete.jsp">Delete Data</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            <a href="tables.html"><i class="fa fa-table fa-fw"></i> Material Outward</a>
                        </li>
                        <li>
                            <a href="forms.html"><i class="fa fa-edit fa-fw"></i>Leave Forms</a>
                        </li>
                        <li>
...
<p>
 ...
 <span id="contentholder1_lblEmpID" class="labelStyle" "> Emp ID :</span>
...
<tr style="text-align: left">
                                        <td style="width: 10px; height: 10px; align="left" >
                                           ...
                                           <span id="contentholder1_lbelEid" class="labelStyle"> <input type="text" name="Fname" disabled/></span>
                                        </td>
                                    </tr>
...
<tr style="text-align:"center">
 ...
 <tr style="text-align: left">
                                        <td style="width: 10px; height: 10px; text-align: left;">
                                            ...
                                            <span> <input type ="text" name="Fname" disabled/></span></span></td>
                                    </tr>
...
<tr style="text-align: left">
                       <td style="width: 0px; height: 10px; text-align:center;">
                                            ...
                                            <span> <input type ="button" name="Save" value=" Delete "/></span></span></td>
                                    </tr>
...
<tr style="text-align: left">
                                        <td style="width: 10px; height: 10px; text-align: left;">
                                           ...
                                           <span> <input type ="text" name="Fname" disabled/></span></span>
                                        </td>
                                    </tr>
                                    <tr style="text-align: left">
                                        <td style="width: 10px; height: 10px; text-align: left;">
